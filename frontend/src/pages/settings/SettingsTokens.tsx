...
export function SettingsTokens() {
  ...
  return (
    <div className="space-y-6">
      ...
      <dialog
        ref={dialogRef}
        className="w-full max-w-lg rounded-lg border border-gray-200 p-0 shadow-xl backdrop:bg-black/40 open:fixed open:top-1/2 open:left-1/2 open:-translate-x-1/2 open:-translate-y-1/2 open:m-0"
      ...
      >
        <div className="p-6 space-y-4">
          ...
          <div className="flex items-center gap-2">
            <code className="flex-1 break-all rounded-md border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-800 select-all">
              {modalToken}
            </code>
            <button
              type="button"
