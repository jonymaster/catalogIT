...
export function ServiceAssignments() {
  ...
  const loadDirectoryPage = useCallback(async (p: number) => {
    setDirectoryLoading(true);
    try {
      const r = await client.get<UserDirectoryPage>("/api/users/page", {
        params: { page: p, per_page: DIRECTORY_PAGE_SIZE },
      });
  ...
  useEffect(() => {
    ...
    void loadDirectoryPage(page);
  }, [manageOpen, page, loadDirectoryPage]);
          ...
          <div className="relative z-10 flex max-h-[90vh] w-full max-w-2xl flex-col rounded-xl border border-gray-200 dark:border-gray-800 bg-white shadow-xl dark:bg-gray-900">
            <div className="border-b border-gray-200 dark:border-gray-700 px-4 py-3">
              ...
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Select users assigned to this service. At most {DIRECTORY_PAGE_SIZE}{" "}
                users per page.
              </p>
            </div>
